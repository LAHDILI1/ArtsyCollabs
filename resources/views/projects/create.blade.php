    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                <form method="post" action="{{route('project.store')}}" class="container mx-auto mt-8">
                    @csrf
                    @method('post')
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div class="mb-4">
                            <label for="partners" class="block text-sm font-semibold text-gray-600">Partners</label>
                            <select multiple name="partners[]" id="partners" class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:border-blue-500">
