                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <form action="{{route('user.update',['user'=> $user] )}}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input value="{{$user->name}}" type="text" name="name" id="name" class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:border-blue-500" required>
                            </div>
                
                            <div class="mb-4">
                                <label for="email" class="block text-sm font-semibold text-gray-600">Email</label>
                                <input value="{{$user->email}}" type="email" name="email" id="email" class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:border-blue-500" required>
                            </div>
                
                            <div class="mb-4">
                                <label for="roles" class="block text-sm font-semibold text-gray-600">Roles</label>
                                <select name="roles" id="roles" class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:border-blue-500">
                            ...
                            <div class="mt-6">
                                <button type="submit" class="w-full px-4 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">save edit</button>
                            </div>
                        </form>
                    </div>
                </div>
