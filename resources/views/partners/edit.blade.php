    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                {{--  --}}
                <form method="post" action="{{route('partner.update',['partner'=> $partner])}}" class="container mx-auto mt-8">
                    @csrf
                    @method('put')
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h1 class="text-2xl font-semibold mb-4">Partner Information</h1>
                
                        <!-- Partner Name Input -->
                        <div class="mb-4">
                            <label for="name_partner" class="block text-sm font-medium text-gray-600">Partner's Name </label>
                            <input value="{{$partner->name_partner}}" type="text" id="name_partner" name="name_partner" class="mt-1 p-2 w-full border rounded-md">
                        </div>
                
                        <!-- Description Input -->
                        <div class="mb-4">
                            <label for="description" class="block text-sm font-medium text-gray-600">Description</label>
                            <textarea  id="description" name="description" rows="4" class="mt-1 p-2 w-full border rounded-md">{{$partner->description}}</textarea>
                        </div>
