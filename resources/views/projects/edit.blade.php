    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                {{--  --}}
                <form method="post" action="{{route('project.update',['project'=> $project])}}" class="container mx-auto mt-8">
                    @csrf
                    @method('put')
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h1 class="text-2xl font-semibold mb-4">project Information</h1>
                
                        <!-- project Name Input -->
                        <div class="mb-4">
                            <label for="title" class="block text-sm font-medium text-gray-600">project's title </label>
                            <input value="{{$project->title}}" type="text" id="title" name="title" class="mt-1 p-2 w-full border rounded-md">
                        </div>
                
                        <!-- Description Input -->
                        <div class="mb-4">
                            <label for="description" class="block text-sm font-medium text-gray-600">Description</label>
                            <textarea  id="description" name="description" rows="4" class="mt-1 p-2 w-full border rounded-md">{{$project->description}}</textarea>
                        </div>
