            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="w-full mt-12">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i> projects artistiques
                    </p>
                        ...
                        <table class="text-left w-full border-collapse"> <!--Border collapse doesn't work on this site yet but it's available in newer tailwind versions -->
                            <thead>
                                <tr>
                                    ...
                                    <th class="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">updated at</th>
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-grey-lighter">
                                    ...
                                    <td class="py-4 px-6 border-b border-grey-light">{{$project->created_at}}</td>
                                    <td class="py-4 px-6 border-b border-grey-light">{{$project->updated_at}}</td>
                                    <td class="text-left py-3 px-4"><a class="hover:text-blue-500" href="mailto:jonsmith@mail.com"></a>
                                        ...
                                        <a href="{{route('project.edit',['project'=>$project])}}">
                                            ...
                                            <form class="" method="post" action="{{route('project.destroy',['project'=>$project])}}">
                                               @csrf
                                               @method('delete')
