                        ...
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="w-1/3 text-left py-3 px-4 uppercase font-semibold text-sm">Partner's Name</th>
                            ...
                            <tbody class="text-gray-700">
                                ...
                                @endif --}}
                                @php
                                     $color = ($i % 2 == 0) ? '' : 'bg-gray-200';
                                @endphp
                                <tr class="{{ $color }}">
                                    <td class="w-1/3 text-left py-3 px-4">{{$partner->id}}</td>
                                    <td  class="w-1/3 text-left py-3 px-4">{{$partner->name_partner}}</td>
                                    <td class="w-1/3 text-left py-3 px-4">{{$partner->created_at}}</td>
                                    <td class="w-1/3 text-left py-3 px-4">{{$partner->updated_at}}</td>
                                    <td class="text-left py-3 px-4"><a class="hover:text-blue-500" href="mailto:jonsmith@mail.com"></a>
                                        ...
                                        <a href="{{route('partner.edit',['partner'=>$partner])}}">
                                            <button class="text-yellow-500 hover:text-yellow-700  font-bold py-1 px-2 mr-2">
                                                Update
                                            </button>
                                            </a>
                                            <form class="" method="post" action="{{route('partner.destroy',['partner'=>$partner])}}">
                                               @csrf
                                               @method('delete')
                                               <button type="submit" class="text-red-500 hover:text-red-700 font-bold py-1 px-3">
                                                Delete
                                              </button>
                                            </form>
